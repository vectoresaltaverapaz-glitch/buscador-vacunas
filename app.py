...
# ==================================================
# COLUMNAS REALES (LISTA COMPLETA DE TU BASE DE DATOS)
# ==================================================
COLUMNAS_REALES = [
...
# ==================================================
# TÍTULOS BONITOS PARA MOSTRAR EN LA TABLA
# ==================================================
RENOMBRES = {
    "año": "Año",
    "distrito": "Distrito",
...
def obtener_genero(row):
    """Calcula el género a partir de las columnas hombre/mujer."""
    ...
    try:
        ...
        if query:
            if tipo == "nombre_nino":
                ...
                # Para CUI, no usamos FTS, lo manejamos en condiciones adicionales
                pass
        ...
        limite = 15 if num_filtros > 2 else 30
        ...
        # --- 4. EJECUTAR CON MANEJO ROBUSTO ---
        try:
            result = client.execute(sql, all_params)
            # Obtener filas y columnas de forma segura
